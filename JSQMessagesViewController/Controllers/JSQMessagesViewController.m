...
- (void)scrollToBottomAnimated:(BOOL)animated
{
    ...
    NSIndexPath *lastCell = [NSIndexPath indexPathForRow:[self.collectionView numberOfItemsInSection:[self.collectionView numberOfSections]-1] inSection:[self.collectionView numberOfSections]-1];
...
{
    [self jsq_setCollectionViewInsetsTopValue:0 bottomValue:CGRectGetMaxY(self.collectionView.frame) - CGRectGetMinY(self.inputToolbar.frame)];
}
